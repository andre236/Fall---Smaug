...
class Scene():
    def __init__(self):
        ...
        self.bg_level3 = pygame.image.load('images/bg/level3_a.png')
        ...
        self.bg_level4 = pygame.image.load('images/bg/level4_a.png')
